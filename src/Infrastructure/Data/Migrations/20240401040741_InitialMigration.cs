    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlowerVariant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FlowerVariant_Flower_FlowerId",
                        column: x => x.FlowerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WrapperVariant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WrapperVariant_Wrapper_WrapperId",
                        column: x => x.WrapperId,
                        principalTable: "Wrapper",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WrapperVariant_WrapperId",
